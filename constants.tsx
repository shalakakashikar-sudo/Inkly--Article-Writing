    ...
    questions: [
      {
        ...
        questionText: 'You have noticed an alarming rise in road accidents in your city, particularly involving young drivers. Write an article in 120-150 words for your school magazine highlighting the causes and suggesting remedial measures.',
      ...
      },
      {
        ...
        questionText: 'Recent reports suggest that elder abuse in urban families is on the rise. Write an article in 120-150 words for a national daily expressing your concern and suggesting ways to address this issue.',
      ...
      },
      {
        ...
        questionText: 'Social media addiction among teenagers has become a growing concern. Write an article in 120-150 words discussing its impact and ways to overcome it.',
    ...
    questions: [
      {
        ...
        questionText: 'Write an article in 120-150 words for your school newsletter on "Plastic Pollution: A Threat to Marine Life" suggesting practical solutions.',
      ...
      },
      {
        ...
        questionText: 'Your city has been experiencing severe water shortage during summers. Write an article in 120-150 words for a local newspaper highlighting the importance of rainwater harvesting.',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for an environmental magazine on "Urban Forests: The Lungs of Our Cities" emphasizing their role and the need for their conservation.',
    ...
    questions: [
      {
        ...
        questionText: 'Write an article in 120-150 words for the school magazine on "Balancing Academics and Extracurricular Activities."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for a youth magazine on "The Dying Art of Reading Books" in the age of digital media.',
      ...
      },
      {
        ...
        questionText: 'After attending a career counseling session, write an article in 120-150 words for your school magazine on "Choosing the Right Career: Passion vs Pressure."',
    ...
    questions: [
      {
        ...
        questionText: 'Write an article in 120-150 words for a technology magazine discussing "Artificial Intelligence: Friend or Foe?"',
      ...
      },
      {
        ...
        questionText: 'Online shopping has become increasingly popular. Write an article in 120-150 words for a consumer awareness magazine discussing its advantages and pitfalls.',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for your school newsletter on "Cashless Economy: Are We Ready?"',
    ...
    questions: [
      {
        ...
        questionText: 'Obesity among children has become a major health concern. Write an article in 120-150 words for a health magazine suggesting preventive measures.',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for your school magazine on "Yoga and Meditation: The Ancient Science for Modern Stress."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for a youth magazine on "Breaking the Stigma Around Mental Health."',
    ...
    questions: [
      {
        ...
        questionText: 'Your school recently organized a cleanliness drive. Write an article in 120-150 words for the school magazine on "Cleanliness: Not Just a Habit, But a Responsibility."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for a national daily on "The Lost Value of Honesty in Modern Times."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for your school magazine on "Respect for All: The Foundation of a Harmonious Society."',
    ...
    questions: [
      {
        ...
        questionText: 'The \'Skill India\' initiative aims to train millions of youth. Write an article in 120-150 words for a national newspaper discussing its importance and challenges.',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for a current affairs magazine on "Women Safety: Moving Beyond Laws to Cultural Change."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for your school magazine on "Patriotism in Everyday Life: Small Acts, Big Impact."',
    ...
    questions: [
      {
        ...
        questionText: 'After witnessing rampant littering during a public event, write an article in 120-150 words on "Public Places, Public Responsibility."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for a magazine on "The Pandemic Effect: Lessons We Must Not Forget."',
      ...
      },
      {
        ...
        questionText: 'Write an article in 120-150 words for your school magazine on "The Power of Small Acts of Kindness."',
